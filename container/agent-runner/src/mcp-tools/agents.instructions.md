...
- Creates a new agent with its own container, workspace, and session. Your `instructions` string seeds the agent's `CLAUDE.md` — its starting role and personality.
