...
If yes, create a NanoClaw scheduled task that runs in the wiki group. This is NOT a Codex cron job — it's a NanoClaw group task that runs in the agent container. Insert it into the SQLite database:
