...
export function listLabeledContainers(): RuntimeContainer[] {
...
export function listLegacyContainers(): string[] {
  return execSync(`${CONTAINER_RUNTIME_BIN} ps --filter name=nanoclaw- --format '{{.Names}}'`, {
